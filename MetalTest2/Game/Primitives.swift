...
public final class Primitives {
    ...
    public static func plane(
        ...
        width : Float,
        height : Float) -> Mesh?{
        let frontColor: CGColor = UIColor.blue.cgColor
        
        var dimension : Float = 5
        let vertices = [
//            BasicVertex(pos: [-2, -2, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [0, 1]),
//            BasicVertex(pos: [2, -2, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [1, 1]),
//            BasicVertex(pos: [2, 2, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [1, 0]),
//            BasicVertex(pos: [-2, -2, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [0, 1]),
//            BasicVertex(pos: [2, 2, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [1, 0]),
//            BasicVertex(pos: [-2, 2, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [0, 0])
            
            // front
            BasicVertex(pos: [-dimension, -dimension, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [0, 1]),
            BasicVertex(pos: [dimension, -dimension, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [1, 1]),
            BasicVertex(pos: [dimension, dimension, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [1, 0]),
            BasicVertex(pos: [-dimension, -dimension, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [0, 1]),
            BasicVertex(pos: [dimension, dimension, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [1, 0]),
            BasicVertex(pos: [-dimension, dimension, 0], normal: [0, 0, 0], color: Vec4.from(frontColor), tex: [0, 0])
        ]
